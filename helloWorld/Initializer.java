...
//		//le noeud 1 envoie un message destine au noeud 2
//		Node emitterNode = Network.get(1);
//		Node destNode = Network.get(2);
//		current=(HelloWorld)emitterNode.getProtocol(this.helloWorldPid);
//		current2=(HelloWorld)destNode.getProtocol(this.helloWorldPid);
//		current.setTransportLayer(1);
//		current2.setTransportLayer(2);
//		Message msg=new Message(5, Long.toString(current2.getUid()),current);
//		current.send(msg, Network.get(0));
